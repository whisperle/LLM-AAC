#!/bin/bash
# Script for inference with H5-based feature models (no encoder)
...
model_dir="/gpfs/scratch/cl6707/Projects/LLM-AAC/exps/Clotho/slam-aac_Clotho_mlp_h5_melspec"

# Define the feature type (mel_spectrogram or cwt)
feature_type="mel_spectrogram"

# H5 feature file path for evaluation
h5_eval_path="/gpfs/scratch/cl6707/Shared/clotho/clotho_evaluation.h5"
# If you need to process your evaluation data into H5 first, use the appropriate script from your codebase

# Define your inference data (if needed for metadata)
...
python $code_dir/inference_aac_batch.py \
    ...
    ++dataset_config.h5_file_path=$h5_eval_path \
    ++dataset_config.h5_val_file_path=$h5_eval_path \
...
# bash /gpfs/scratch/cl6707/Projects/LLM-AAC/SLAM-LLM/examples/slam_aac/scripts/inference_clotho_h5_feature.sh 