#!/bin/bash
# Script for inference with H5-based models with CLAP refinement
...
model_dir="/gpfs/scratch/cl6707/Projects/LLM-AAC/exps/Clotho/slam-aac_Clotho_mlp_h5_cwt"

# Define the feature type (mel_spectrogram or cwt)
feature_type="cwt"  # Match your training configuration
...
# bash /gpfs/scratch/cl6707/Projects/LLM-AAC/SLAM-LLM/examples/slam_aac/scripts/inference_clotho_CLAP_Refine_h5.sh 