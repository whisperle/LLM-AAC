...
feature_type=mel_spectrogram  # Options: 'mel_spectrogram', 'cwt', 'audio'
...
exp_name=slam-aac_Clotho_mlp_h5_melspec
...
# bash /gpfs/scratch/cl6707/Projects/LLM-AAC/SLAM-LLM/examples/slam_aac/scripts/finetune_clotho_mlp_h5_melspec.sh 