...
seed=10086
btz=4
lr=5e-4  # Higher learning rate for MLP (simpler architecture)
encoder_projector_ds_rate=5

# H5 dataset paths
h5_train_path=/gpfs/scratch/cl6707/Shared/clotho/clotho_development.h5
h5_val_path=/gpfs/scratch/cl6707/Shared/clotho/clotho_validation.h5
feature_type=cwt  # Options: 'mel_spectrogram', 'cwt', 'audio'
cwt_wavelet=morl  # Correct wavelet name for PyWavelets
...
exp_name=slam-aac_Clotho_mlp_h5_cwt
...
++model_config.encoder_projector_num_layers=$mlp_layers \
++model_config.encoder_projector_hidden_dim=$mlp_hidden_dim \
++model_config.encoder_projector_dropout=$mlp_dropout \
...
++dataset_config.h5_file_path=$h5_train_path \
++dataset_config.h5_val_file_path=$h5_val_path \
...
# bash /gpfs/scratch/cl6707/Projects/LLM-AAC/SLAM-LLM/examples/slam_aac/scripts/finetune_clotho_mlp_h5_cwt.sh 