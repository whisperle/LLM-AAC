...
seed=10086
btz=4
lr=5e-4  # Higher learning rate for MLP training (simpler architecture)
...
exp_name=slam-aac_Clotho_mlp_cwt_wav
...
# bash /gpfs/scratch/cl6707/Projects/LLM-AAC/SLAM-LLM/examples/slam_aac/scripts/finetune_clotho_mlp_cwt.sh 