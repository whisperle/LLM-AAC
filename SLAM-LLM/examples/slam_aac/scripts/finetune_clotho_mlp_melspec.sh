...
# Force using ClothoFeatureDataset (no metadata)
export USE_METADATA=0
...
feature_type=mel_spectrogram  # Using mel spectrogram features directly
...
exp_name=slam-aac_Clotho_mlp_melspec_wav
...
# bash /gpfs/scratch/cl6707/Projects/LLM-AAC/SLAM-LLM/examples/slam_aac/scripts/finetune_clotho_mlp_melspec.sh 