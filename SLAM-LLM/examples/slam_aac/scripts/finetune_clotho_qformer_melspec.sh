...
exp_name=slam-aac_Clotho_qformer_melspec_wav
...
# bash /gpfs/scratch/cl6707/Projects/LLM-AAC/SLAM-LLM/examples/slam_aac/scripts/finetune_clotho_qformer_melspec.sh 