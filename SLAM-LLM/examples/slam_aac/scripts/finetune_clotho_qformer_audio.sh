...
feature_type=audio  # Using raw audio waveform directly

exp_name=slam-aac_Clotho_qformer_audio_wav
...
# bash /gpfs/scratch/cl6707/Projects/LLM-AAC/SLAM-LLM/examples/slam_aac/scripts/finetune_clotho_qformer_audio.sh 