...
class ModelConfig:
    ...
    encoder_projector_num_queries: int = 32
    encoder_projector_num_layers: int = 2
    encoder_projector_hidden_dim: int = 768
    encoder_projector_num_heads: int = 12
    encoder_projector_dropout: float = field(default=0.1, metadata={
        "help": "Dropout rate for the encoder projector MLP layers"
    })
...
class DataConfig:
    ...
    # H5 dataset specific parameters
    h5_file_path: Optional[str] = None
    h5_val_file_path: Optional[str] = None
    ...
    encoder_projector_ds_rate: int = 5
    encoder_dim: int = field(default=64, metadata={
        "help": "Feature dimension expected by the encoder model"
    })
    ...
    # Add CWT parameters
    cwt_wavelet: str = field(default="morl", metadata={
        "help": "Wavelet to use for continuous wavelet transform (e.g., 'morl', 'gaus1')"
    })
    cwt_scales: Optional[List[int]] = field(default=None, metadata={
        "help": "Scales for continuous wavelet transform. None for automatic determination."
    })
